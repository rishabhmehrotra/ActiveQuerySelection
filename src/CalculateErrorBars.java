...
public class CalculateErrorBars {
	...
	public static void main(String[] args) throws IOException{
		...
		BufferedReader br = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Combined/COMBINED_topic"));
		//BufferedReader br = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2007MQ/Combined/COMBINED_ELO_fulllimit_"));
