...
public class SuperDriver {
	...
	public static String suffix = "FORAP_FScore";
	...
	private static void moveFilesAfterEndOfFold(int j) throws IOException {
		...
		//*/
		/*
		String sFile1 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/NDCG_RANDOM_errorBars.txt";
		String sFile2 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/AP_RANDOM_errorBars.txt";
		String sFile3 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/resultsAT10.txt";
		*/
		...
		*/
		/*
		String dFile1 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/2007MQ/Fold"+j+"/NDCG_errorBars_"+suffix+j+"1.txt";
		String dFile2 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/2007MQ/Fold"+j+"/AP_errorBars_"+suffix+j+"1.txt";
		String dFile3 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/2007MQ/Fold"+j+"/resultsAT10_"+suffix+j+"1.txt";
		*/
		/*
		String dFile1 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/OHSUMED/Fold"+j+"/NDCG_errorBars_"+suffix+j+"1.txt";
		String dFile2 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/OHSUMED/Fold"+j+"/AP_errorBars_"+suffix+j+"1.txt";
		String dFile3 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/OHSUMED/Fold"+j+"/resultsAT10_"+suffix+j+"1.txt";
		*/
		///*
		String dFile1 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/OHSUMED/Fold"+j+"/NDCG_errorBars_"+suffix+f1+"-"+f2+"_"+j+"1.txt";
		String dFile2 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/OHSUMED/Fold"+j+"/AP_errorBars_"+suffix+f1+"-"+f2+"_"+j+"1.txt";
		String dFile3 = "/Users/rishabhmehrotra/dev/workspace/ActiveQuerySelection/src/data/LETOR/forEval/results/OHSUMED/Fold"+j+"/resultsAT10_"+suffix+f1+"-"+f2+"_"+j+"1.txt";
		//*/
		File source, dest;
	...
	private static void moveFilesBeforeStartOfFold(int j) throws IOException{
		...
		*/
		///*
		String sFile1 = "/Users/rishabhmehrotra/dev/UCL/ActiveQuerySelection/OHSUMED/QueryLevelNorm/Fold"+j+"/train.txt";
		String sFile2 = "/Users/rishabhmehrotra/dev/UCL/ActiveQuerySelection/OHSUMED/QueryLevelNorm/Fold"+j+"/test.txt";
		String sFile3 = "/Users/rishabhmehrotra/dev/UCL/ActiveQuerySelection/OHSUMED/QueryLevelNorm/Fold"+j+"/valid.txt";
		//*/
