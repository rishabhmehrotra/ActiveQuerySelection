...
public class CalculateRANDOMErrorBars {
	...
	public static void main(String[] args) throws IOException{
		...
		BufferedReader br1 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Fold2/AP_RANDOM_errorBars_QBCap.txt"));
		BufferedReader br2 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Fold2/AP_RANDOM_errorBars_LDAap.txt"));
		
		//BufferedReader br1 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2007MQ/Fold1/NDCG_RANDOM_errorBars_B10_QBC.txt"));
		//BufferedReader br2 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2007MQ/Fold1/NDCG_RANDOM_errorBars_B10_LDA.txt"));
		FileWriter fstream = new FileWriter("src/data/LETOR/forEval/results/2008MQ/Fold2/RANDOM_Combinedap");
		...
		BufferedReader br = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Fold2/RANDOM_Combined"));
