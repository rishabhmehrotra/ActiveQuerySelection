...
public class CombineErrorBars {
	...
	public static void main(String[] args) throws IOException{
		...
		BufferedReader br2 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2007MQ/Combined/NDCG_errorBars_B10_"+algo+"12.txt"));
		BufferedReader br3 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2007MQ/Combined/NDCG_errorBars_B10_"+algo+"11.txt"));
		...
		*/
		...
		BufferedReader br2 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Combined/NDCG_errorBars_"+algo+"2.txt"));
		BufferedReader br3 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Combined/NDCG_errorBars_"+algo+"3.txt"));
		BufferedReader br4 = new BufferedReader(new FileReader("src/data/LETOR/forEval/results/2008MQ/Combined/NDCG_errorBars_"+algo+"42.txt"));
